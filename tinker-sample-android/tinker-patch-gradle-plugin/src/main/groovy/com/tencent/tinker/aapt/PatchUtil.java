...
public final class PatchUtil {
    ...
    public static Map<RDotTxtEntry.RType, Set<RDotTxtEntry>> readRTxt(String rTxtFullFilename) {
        ...
        Map<RDotTxtEntry.RType, Set<RDotTxtEntry>> rTypeResourceMap = new HashMap<RDotTxtEntry.RType, Set<RDotTxtEntry>>();
    ...
    public static void generatePublicResourceXml(AaptResourceCollector aaptResourceCollector, String outputIdsXmlFullFilename, String outputPublicXmlFullFilename) {
        ...
        try {
            ...
            Iterator<Entry<RDotTxtEntry.RType, Set<RDotTxtEntry>>> iterator = map.entrySet().iterator();
            while (iterator.hasNext()) {
                ...
                if (!rType.equals(RDotTxtEntry.RType.STYLEABLE)) {
                    ...
                    for (RDotTxtEntry rDotTxtEntry : set) {
                        if (rType.equals(RDotTxtEntry.RType.ID) && !ignoreIdSet.contains(rDotTxtEntry.name)) {
                            idsWriter.println("<item type=\"" + rType + "\" name=\"" + rDotTxtEntry.name + "\"/>");
                        } else if (rType.equals(RDotTxtEntry.RType.STYLE)) {
