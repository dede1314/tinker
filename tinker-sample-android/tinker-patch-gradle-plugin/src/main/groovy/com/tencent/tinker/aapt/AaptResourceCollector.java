...
package com.tencent.tinker.aapt;
...
public class AaptResourceCollector {
    ...
    public AaptResourceCollector() {
        this.rTypeResourceDirectoryMap = new HashMap<RDotTxtEntry.RType, Map<String, Set<ResourceDirectory>>>();
        ...
        this.rTypeEnumeratorMap = new HashMap<RDotTxtEntry.RType, ResourceIdEnumerator>();
        this.rTypeResourceMap = new HashMap<RDotTxtEntry.RType, Set<RDotTxtEntry>>();
        this.rTypeIncreaseResourceMap = new HashMap<RDotTxtEntry.RType, Set<RDotTxtEntry>>();
        this.duplicateResourceMap = new HashMap<String, Set<String>>();
        this.sanitizeTypeMap = new HashMap<RDotTxtEntry.RType, HashMap<String, String>>();
    ...
    public void addIntResourceIfNotPresent(RDotTxtEntry.RType rType, String name) { //, ResourceDirectory resourceDirectory) {
        ...
        RDotTxtEntry entry = new FakeRDotTxtEntry(RDotTxtEntry.IdType.INT, rType, name);
        ...
        if (!resourceSet.contains(entry)) {
            ...
            addResource(rType, RDotTxtEntry.IdType.INT, name, idValue); //, resourceDirectory);
        }
    }
    ...
    public void addIntArrayResourceIfNotPresent(RDotTxtEntry.RType rType, String name, int numValues) {
        ...
        addResource(rType, RDotTxtEntry.IdType.INT_ARRAY, name, idValue);
    }
